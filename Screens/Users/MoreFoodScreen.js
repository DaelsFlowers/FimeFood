...
//Food Imagens
import ImagenPref from "../../assets/FMore.jpg"



export default function MoreFoodScreen({ navigation }) {
    ...
    async function loadData() {
        try {
            firestore().collection("Productos").where("categoria", "==", "OTROS").get().then((query) => {
                const ProductList = []
                query.forEach(doc => {
    ...
    return (
        ...
        <SafeAreaView style={styles.View}>
            ...
            <View style={styles.ContentView}>
                {/* BUSCADOR */}
                <View>
                    <Text style={{ textAlign: "center", fontSize: 22, fontWeight: 'bold' }}>MAS COMIDA</Text>
                </View>
