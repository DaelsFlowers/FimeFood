...
//Food Imagens
import ImagenPref from "../../assets/FPostres.jpg"


export default function PostresScreen({ navigation }) {
    ...
    async function loadData() {
        try {
            firestore().collection("Productos").where("categoria", "==", "POSTRES").get().then((query) => {
                const ProductList = []
                query.forEach(doc => {
