...
//Food Imagens
import ImagenPref from "../../assets/FHamburgesa.jpg"



export default function HambuergesasScreen({ navigation }) {
    ...
    async function loadData() {
        try {
            firestore().collection("Productos").where("categoria", "==", "HAMBURGESAS").get().then((query) => {
                const ProductList = []
                query.forEach(doc => {
    ...
    return (
        ...
        <SafeAreaView style={styles.View}>
            ...
            <View style={styles.ContentView}>
                {/* BUSCADOR */}
                <View>
                    <Text style={{ textAlign: "center", fontSize: 22, fontWeight: 'bold' }}>HAMBURGESAS</Text>
                </View>
