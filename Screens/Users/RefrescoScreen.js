...
//Food Imagens
import ImagenPref from "../../assets/FRefrescos.jpg"


export default function RefrescoScreen({ navigation }) {
    ...
    async function loadData() {
        try {
            firestore().collection("Productos").where("categoria", "==", "BEBIDAS").get().then((query) => {
                const ProductList = []
                query.forEach(doc => {
    ...
    return (
        ...
        <SafeAreaView style={styles.View}>
            ...
            <View style={styles.ContentView}>
                {/* BUSCADOR */}
                <View>
                    <Text style={{ textAlign: "center", fontSize: 22, fontWeight: 'bold' }}>BEBIDAS</Text>
                </View>
